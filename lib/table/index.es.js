...
const toDisplayString = (val) => {
  return isString(val) ? val : val == null ? "" : isArray$4(val) || isObject$6(val) && (val.toString === objectToString$2 || !isFunction$3(val.toString)) ? JSON.stringify(val, replacer, 2) : String(val);
};
const replacer = (_key, val) => {
  ...
  } else if (isObject$6(val) && !isArray$4(val) && !isPlainObject(val)) {
    return String(val);
  }
  return val;
};
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  emits: ["confirm", "cancel", "update:editRowType", "sizeChange", "currentChange"],
  setup(__props, { emit: emits }) {
    const props = __props;
    let currentEdit = ref("");
    let tableData = ref(cloneDeep_1(props.data));
    watch(() => props.data, (val) => {
      tableData.value = cloneDeep_1(val);
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        withDirectives((openBlock(), createBlock(_component_el_table, mergeProps(_ctx.$attrs, {
          data: unref(tableData),
          "element-loading-text": __props.elementLoadingText,
          "element-loading-spinner": __props.elementLoadingSpinner,
          "element-loading-svg": __props.elementLoadingSvg,
          "element-loading-svg-view-box": __props.elementLoadingSvgViewBox,
          "element-loading-background": __props.elementLoadingBackground,
          onRowClick: rowClick
        }), {
          default: withCtx(() => {
            var _a, _b, _c;
            return [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(tableOptions), (item, index2) => {
                return openBlock(), createBlock(_component_el_table_column, {
                  ...
                  default: withCtx((scope) => [
                    scope.row.rowEdit ? (openBlock(), createBlock(_component_el_input, {
                      key: 0,
                      size: "small",
                      ...
                      scope.$index + scope.column.id === unref(currentEdit) ? (openBlock(), createElementBlock("div", _hoisted_1, [
                        ...
                        createBaseVNode("div", {
                          class: "edit-action-wrap",
                          onClick: withModifiers(clickEditCell, ["stop"])
                        }, [
                          _ctx.$slots.editCell ? renderSlot(_ctx.$slots, "editCell", {
                            key: 0,
                            scope
                          }, void 0, true) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                            createVNode(_component_Check, {
                              class: "check edit",
                              onClick: ($event) => check(scope)
                            }, null, 8, ["onClick"]),
                            createVNode(_component_Close, {
                              class: "close edit",
                              onClick: ($event) => close(scope)
                            }, null, 8, ["onClick"])
                          ], 64))
                        ], 8, _hoisted_2)
                        ...
                        item.slot ? renderSlot(_ctx.$slots, item.slot, {
                          key: 0,
                          scope
                        }, void 0, true) : (openBlock(), createElementBlock("span", _hoisted_4, toDisplayString(scope.row[item.prop]), 1)),
                        item.editable ? (openBlock(), createBlock(resolveDynamicComponent(__props.editIcon), {
                          key: 2,
                          class: "edit",
                          onClick: withModifiers(($event) => clickEdit(scope), ["stop"])
              ...
              createVNode(_component_el_table_column, {
                label: (_a = unref(actionOptions)) == null ? void 0 : _a.label,
                align: (_b = unref(actionOptions)) == null ? void 0 : _b.align,
                width: (_c = unref(actionOptions)) == null ? void 0 : _c.width
              }, {
                default: withCtx((scope) => [
                  scope.row.rowEdit ? renderSlot(_ctx.$slots, "editRow", { key: 0 }, void 0, true) : renderSlot(_ctx.$slots, "action", {
                    key: 1,
                    scope
                  }, void 0, true)
                ]),
        ...
        __props.pagination ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: "pagination",
          style: normalizeStyle({ justifyContent: unref(paginationAlignJustify) })
        }, [
...
var table = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6c967c4b"]]);
var index = {
  install(app) {
