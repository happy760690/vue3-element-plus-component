  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        class: normalizeClass({ "m-choose-icon-dialog-body-height": __props.isScorll })
      }, [
        createVNode(_component_el_dialog, mergeProps({
          ...
          default: withCtx(() => [
            createVNode(_component_m_form, {
              ...
              _: 3
            }, 8, ["options", "onOnChange", "onOnPreview", "onOnRemove", "onBeforeRemove", "onOnExceed", "onOnError", "onOnSuccess"])
          ]),
          footer: withCtx(() => [
