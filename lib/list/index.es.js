          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.list, (item, index2) => {
              return openBlock(), createBlock(_component_el_tab_pane, {
                ...
                default: withCtx(() => [
                  createVNode(_component_el_scrollbar, { "max-heigth": "300px" }, {
                    default: withCtx(() => [
                  ...
                  createBaseVNode("div", _hoisted_3, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(__props.actions, (action, i) => {
                      return openBlock(), createElementBlock("div", {
                        ...
                        action.icon ? (openBlock(), createElementBlock("div", _hoisted_5, [
                          (openBlock(), createBlock(resolveDynamicComponent(action.icon)))
                        ])) : createCommentVNode("", true),
                        createBaseVNode("div", _hoisted_6, toDisplayString(action.text), 1)
                      ], 8, _hoisted_4);
                    }), 128))
                  ])
                ]),
...
var list = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-58a9965f"]]);
var index = {
  install(app) {
