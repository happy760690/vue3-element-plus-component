...
const _hoisted_2 = /* @__PURE__ */ createTextVNode("\u6309\u57CE\u5E02");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    let changeSelect = (val) => {
      ...
      let city2 = allCities.find((item) => item.id === val);
      console.log(city2);
      result.value = (city2 == null ? void 0 : city2.name) + "";
      visible.value = false;
      emits("changeValue", city2 == null ? void 0 : city2.name);
    };
    return (_ctx, _cache) => {
        ...
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_1, [
            ...
            createBaseVNode("div", _hoisted_3, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(Object.keys(unref(cities)), (value, index2) => {
                return openBlock(), createElementBlock("div", {
                  class: "city-item",
                  onClick: ($event) => unref(clickChat)(value),
                  key: index2
                }, toDisplayString(value), 9, _hoisted_4);
              }), 128))
            ]),
                        ...
                        default: withCtx(() => [
                          (openBlock(true), createElementBlock(Fragment, null, renderList(value, (item) => {
                            return openBlock(), createElementBlock("div", {
                              ...
                              key: item.id
                            }, toDisplayString(item.name), 9, _hoisted_5);
                          }), 128))
                        ]),
                        _: 2
                      }, 1024)
...
var chooseCity = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d82e625a"]]);
var index = {
  install(app) {
