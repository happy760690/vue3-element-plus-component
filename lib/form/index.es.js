  ...
  setup(__props, { expose, emit: emits }) {
    ...
    let initForm = () => {
      if (props.options && props.options.length) {
        ...
        model.value = cloneDeep_1(m);
        rules.value = cloneDeep_1(r);
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.options, (item, index2) => {
            return openBlock(), createElementBlock(Fragment, { key: index2 }, [
              !item.children || !item.children.length ? (openBlock(), createBlock(_component_el_form_item, {
                ...
                default: withCtx(() => [
                  item.type !== "upload" ? (openBlock(), createBlock(resolveDynamicComponent(`el-${item.type}`), mergeProps({ key: 0 }, item.attrs, {
                  ...
                  item.type === "upload" ? (openBlock(), createBlock(_component_el_upload, mergeProps({ key: 1 }, item.uploadAttrs, {
                    ...
                    _: 2
                  }, 1040, ["on-preview", "on-remove", "on-success", "on-error", "on-progress", "on-change", "on-exceed", "before-upload", "before-remove", "http-request"])) : createCommentVNode("", true)
                ]),
                _: 2
              ...
              item.children && item.children.length ? (openBlock(), createBlock(_component_el_form_item, {
                ...
                default: withCtx(() => [
                  (openBlock(), createBlock(resolveDynamicComponent(`el-${item.type}`), mergeProps(item.attrs, {
                    modelValue: unref(model)[item.prop],
                    "onUpdate:modelValue": ($event) => unref(model)[item.prop] = $event
                  }), {
                    default: withCtx(() => [
